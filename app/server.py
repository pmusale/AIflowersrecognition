...
model_file_name = 'flowers'
classes = ['African Lily', 'Aster', 'Crocus', 'Daffodil', 'Daisy', 'Evening Primrose', 'Forget-Me-Nots', 'Hellebore', 'Hibiscus', 'Impatiens', 'Jasmine', 'Lavender', 'Magnolia']  
