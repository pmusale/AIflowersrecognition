...
def download_google_staticimages(item):

    searchurl = 'https://www.google.com/search?q=' + item  + '&source=lnms&tbm=isch'
    dirs = 'pictures/' +  item
...
def main():
    ...
    items = ["Crocus", "Daffodil", "Daisy", "Evening Primrose","Forget-Me-Nots","Hellebore","Hibiscus","Impatiens","Jasmine","Lavender","Magnolia"]

    for item in items:
        t0 = time.time()
        count = download_google_staticimages(item)
        t1 = time.time()
        total_time = t1 - t0
        print(f'\n')
